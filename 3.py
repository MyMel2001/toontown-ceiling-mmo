...
LoadingZone.define(182, 186, 192, 196, 14, entryPos=(0, 20, 0.025), entryHpr=(0, 0, 0))

# Labyrinth Lane (zone 21) - Tunnel at (-109.48, 292.95, 3.36) facing -130
# Zone placed 5 units in front of tunnel entrance
LoadingZone.define(-114, 287, -104, 297, 21, entryPos=(0, 20, 0.025), entryHpr=(0, 0, 0))

# Oak Street (zone 22) - Tunnel at (-60.12, -94.82, -6.63) facing 0
# Zone placed 5 units in front of tunnel entrance
LoadingZone.define(-65, -99, -55, -89, 22, entryPos=(0, 20, 0.025), entryHpr=(0, 0, 0))
